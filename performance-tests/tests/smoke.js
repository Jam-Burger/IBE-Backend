...
import { BASE_CONFIG, SMOKE_CONFIG, REPORT_CONFIG } from './config.js';
...
// Custom metrics for HTML report
export const metrics = {
  paths: {},
};

export const options = {
  vus: SMOKE_CONFIG.VUS,
  duration: SMOKE_CONFIG.DURATION,
  thresholds: SMOKE_CONFIG.THRESHOLDS,
};
...
export default function() {
  TEST_ENDPOINTS.SMOKE.forEach(endpoint => {
...
export function handleSummary(data) {
  ...
  const reportPath = `${REPORT_CONFIG.OUTPUT_DIR}/${REPORT_CONFIG.getFilename('smoke')}`;
